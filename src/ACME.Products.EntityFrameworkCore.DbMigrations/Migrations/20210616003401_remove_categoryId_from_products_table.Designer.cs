...
namespace ACME.Products.Migrations
{
    ...
    [Migration("20210616003401_remove_categoryId_from_products_table")]
    partial class remove_categoryId_from_products_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ACME.Products.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ACME.Products.ProductCategories.ProductCategory", b =>
                {
            ...
            modelBuilder.Entity("ACME.Products.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ACME.Products.ProductCategories.ProductCategory", b =>
                {
                    b.HasOne("ACME.Products.Categories.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ACME.Products.Products.Product", null)
