...
namespace ACME.Products.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ProductsDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ProductsEfCoreEntityExtensionMappings to extend the IdentityUser entity
