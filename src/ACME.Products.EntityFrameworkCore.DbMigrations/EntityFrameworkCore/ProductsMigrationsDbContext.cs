...
namespace ACME.Products.EntityFrameworkCore
{
     ...
     * It is not used on runtime. See ProductsDbContext for the runtime DbContext.
     * It is a unified model that includes configuration for
     * all used modules and your application.
     */
    public class ProductsMigrationsDbContext : AbpDbContext<ProductsMigrationsDbContext>
    {
        public ProductsMigrationsDbContext(DbContextOptions<ProductsMigrationsDbContext> options) 
            : base(options)
        {
